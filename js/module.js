...
var Module = Class.extend({
    ...
    notificationReceived: function (notification, payload, sender) {
        ...
        // Log.error("------------------>");
        // this.super.notificationReceived(notification, payload, sender);
    },
    afterNotificationReceived: function (notification, payload, sender) {
        if (notification === 'VOICE_COMMAND' && payload.module === this.name) {
            this.show()
        }
    },
    ...
    setData: function (data) {
        ...
        this.hidden = data.hasOwnProperty("hidden") ? data.hidden : false;
